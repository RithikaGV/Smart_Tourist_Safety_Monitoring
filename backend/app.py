...
# Admin / officer control panel (dashboard, heatmap, SOS + E-FIR monitoring,
# zone management, AI analytics, incidents, officer roster)
app.include_router(admin_panel_routes.router)
app.include_router(admin_panel_routes.officer_router)
